...
# 👋 Hi, I'm Dominik Žabčík

### Lead Backend Developer @ NFCtron 🚀

_Building scalable, robust, and efficient server-side solutions that power modern applications_

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/dominikzabcik)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:zabcik@nfctron.com)
...
I'm a **Lead Backend Developer** with a passion for crafting clean architecture and delivering high-performance systems. I specialize in building scalable backend infrastructure that handles millions of transactions, powers real-time event management, and ensures secure payment processing.

**🔭 Currently:** Leading backend development at [@NFCtron](https://github.com/NFCtron), building the infrastructure that powers cashless payments and event management across Europe.

**💡 Fun Fact:** I love solving complex problems with elegant solutions and believe that great backend code should be both performant and maintainable.
...
- **Database Design** - PostgreSQL optimization, query tuning, migrations
- **Architecture** - Microservices, event-driven architecture, clean code principles
- **Performance** - Caching strategies, load balancing, database optimization

### DevOps & Infrastructure

- **CI/CD** - GitHub Actions, automated testing, deployment pipelines
- **Containerization** - Docker, Kubernetes orchestration
- **Cloud Services** - AWS infrastructure, serverless architecture
...
- **Security** - PCI-DSS compliance, OWASP guidelines, secure coding
...
- 🚀 Optimizing database performance for high-traffic scenarios
